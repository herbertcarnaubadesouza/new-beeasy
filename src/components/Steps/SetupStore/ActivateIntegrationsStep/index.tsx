...
import SideModal from "@/components/RightSidebar";
import { useState } from "react";

interface ActivateIntegrationsStepProps {
  onOpenModal: () => void;
  onCloseModal: () => void;
  onIntegrationClick: (integrationName: string) => void;
}
...
const ActivateIntegrationsStep: React.FC<ActivateIntegrationsStepProps> = ({
  onOpenModal,
  onCloseModal,
  onIntegrationClick,
}) => {
        ...
        <div className={styles["buttons-container"]}>
          {integrations.map((integration) => (
            <CardButton
              ...
              hideLabel
              onClick={() => {
                onIntegrationClick(integration.name);
              }}
              icon={
                <img
