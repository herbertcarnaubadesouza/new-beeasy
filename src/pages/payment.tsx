import MainSection from "@/components/MainSectionPayment";
...
import styles from "../styles/Payment.styles.module.scss";
...
const Assinatura: NextPageWithLayout = () => {
  ...
  return (
    <MainSection
      ...
      description="Confira abaixo os valores cobrados"
    ></MainSection>
  );
};
